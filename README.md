...
Интерактивный LLM-чат Qwen3-4B и специализированный анализ тематик Qwen3-0.6B
работают в разных локальных процессах. Анализ запускается только по кнопке, имеет
пониженный приоритет ОС и не занимает вычислительный слот ответа пользователю.
