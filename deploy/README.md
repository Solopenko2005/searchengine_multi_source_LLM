...
шестью наиболее релевантными фрагментами, 14 000 символами общего бюджета и 512
токенами ответа. Для локальной модели сервис дополнительно сокращает передаваемые
выдержки примерно до 3 600 символов. Лимиты и тайм-аут можно изменить через
