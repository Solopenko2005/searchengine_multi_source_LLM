(function () {
    ...
    var messages = {
        en: {
            ...
            'auth.login.title': 'Sign in — research search',
            'auth.register.title': 'Sign up — research search',
            'auth.welcome': 'Hello!',
    ...
    var exact = {
        ...
        'Ищите статьи через открытые научные API или переходите в проверенные российские каталоги.': 'Search articles through open scientific APIs or browse trusted Russian catalogues.',
